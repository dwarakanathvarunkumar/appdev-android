...
class _ProfileSetupScreenState extends State<ProfileSetupScreen> {
  ...
  void initState() {
    ...
    if (authProvider.userProfile != null) {
      ...
      _orgNameController.text = authProvider.userProfile!.orgName;
      _emailController.text = authProvider.userProfile!.email;
      _phoneController.text = authProvider.userProfile!.phone;
      _selectedCategory = authProvider.userProfile!.category.isNotEmpty 
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'This information will be used for your digital visiting card',
  ...
  Future<void> _saveProfile(BuildContext context) async {
    ...
    final updatedProfile = UserModel(
      ...
      joinedAt: authProvider.userProfile?.joinedAt ?? DateTime.now(),
    );
